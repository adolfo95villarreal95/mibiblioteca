                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="codigo" class="form-control" type="text" name="codigo" required placeholder="Matricula del estudiante">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="dni">Ine</label>
                                <input id="dni" class="form-control" type="text" name="dni" required placeholder="Ine">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
